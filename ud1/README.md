# Documentacion UD1 Lenguaje de marcas
...
|Tipo|Uso|Ejemplos|
|----|---|--------|
|Presentación|Dar formato a documento de texto|HTML, CSS|
|Intercambio de información|Almacenar informacion de forma ordenada|XML, RSS|
...
```
4. Configuramos repositorio git
```bash
git init
git add .
